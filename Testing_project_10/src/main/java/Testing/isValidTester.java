...
class isValidTester {
	...
	void test3() {
		...
		Verfication verfication = new Verfication();
		boolean actual = verfication.isValidSubjectName("TOM");
	    assertEquals(expected,actual);
	}
	...
	void test5() {
		boolean expected = true;
		Verfication verfication = new Verfication();
		boolean actual = verfication.isValidSubjectName("Tom Holland");
	    assertEquals(expected,actual);
	}
	...
	void test6() {
		boolean expected = false;
		Verfication verfication = new Verfication();
		boolean actual = verfication.isValidSubjectName("Tom123");
	    assertEquals(expected,actual);
	}
